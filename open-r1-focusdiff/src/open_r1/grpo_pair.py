...
from grpo_trainer_2 import GRPOTrainer
...
def main(script_args, training_args, model_args):
    ...
    # Load the dataset
    from mydataset import MyT2IDataset2
    train_dataset = MyT2IDataset2(
        paired_data_path=training_args.paired_data_path, 
        not_paired_data_path=training_args.not_paired_data_path, 
        image_path=training_args.image_path
    )
